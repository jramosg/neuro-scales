...
export const ui: Record<Langs, Record<string, string>> = {
  es: {
    ...
    'index.subtitle': 'Herramientas de evaluación clínica estandarizadas para profesionales de la salud',
    ...
    'barthel.description': 'Evalúa el nivel de independencia funcional en 10 actividades básicas de la vida diaria. Ampliamente utilizado en geriatría, neurología y rehabilitación.',
    'barthel.instructions': 'Seleccione la opción que mejor describa la capacidad actual del paciente en cada actividad. Basearse en el comportamiento observado en las últimas 24-48 horas.',
    ...
    'barthel.feeding.opt-10': 'Independiente — come sin ayuda en tiempo razonable',
    'barthel.feeding.opt-5': 'Necesita ayuda — cortar alimentos, untar pan, etc.',
    ...
    'barthel.grooming.opt-5': 'Independiente — lavarse cara, peinarse, afeitarse',
    ...
    'barthel.dressing.opt-5': 'Necesita ayuda — realiza al menos la mitad sin ayuda',
    ...
    'barthel.transfers.opt-5': 'Gran ayuda — puede sentarse, necesita ayuda para transferirse',
    ...
    'results.independent.desc': 'La persona es completamente independiente en las actividades básicas de la vida diaria.',
    'results.mild': 'Dependencia leve',
    'results.mild.desc': 'Necesita mínima asistencia para algunas actividades cotidianas.',
    'results.moderate': 'Dependencia moderada',
    'results.moderate.desc': 'Requiere ayuda para varias actividades básicas diarias.',
    'results.severe': 'Dependencia grave',
    'results.severe.desc': 'Necesita asistencia considerable para la mayoría de las actividades.',
    'results.total': 'Dependencia total',
    'results.total.desc': 'Requiere ayuda para todas las actividades básicas de la vida diaria.',
    ...
    'footer.disclaimer': 'Herramienta de uso profesional. No sustituye el criterio clínico.',
    ...
    'nihss.description': 'Cuantifica el déficit neurológico en el ictus isquémico agudo mediante 15 ítems. Guía la selección de tratamiento y predice el pronóstico funcional.',
    'nihss.instructions': 'Puntuar según la respuesta observada. No instruir al paciente. Si hay dudas, elegir la puntuación más alta. Anotar 9 (N/A) en ítems no evaluables por amputación o inaccesibilidad.',
    ...
    'nihss.loc_questions.note': 'Preguntar el mes y la edad del paciente. No ayudar con gestos.',
    ...
    'nihss.loc_commands.note': 'Ordenar abrir/cerrar los ojos y empuñar/abrir la mano no parética.',
    ...
    'nihss.gaze.note': 'Solo movimientos oculares horizontales voluntarios o reflejos (oculocefálico).',
    'nihss.gaze.opt-0': 'Normal',
    'nihss.gaze.opt-1': 'Paresia parcial — desviación o paresia pero no forzada',
    'nihss.gaze.opt-2': 'Desviación forzada — paresia total no superable',

    // 3. Campos visuales
    'nihss.visual.label': '3. Campos visuales',
    'nihss.visual.note': 'Confrontación visual en cada cuadrante. Si ceguera unilateral, puntuar campo del ojo sano.',
    ...
    'nihss.facial_palsy.opt-1': 'Paresia menor — asimetría en la sonrisa, pliegue nasolabial aplanado',
    'nihss.facial_palsy.opt-2': 'Paresia parcial — parálisis total de hemicara inferior',
    ...
    'nihss.upper_limbs.note': 'Mantener brazo extendido a 90° (sentado) o 45° (decúbito) durante 10 s. Anotar N/A si amputación u otra causa.',
    ...
    'nihss.lower_limbs.note': 'Mantener pierna extendida a 30° en decúbito durante 5 s. Anotar N/A si amputación u otra causa.',
    ...
    'nihss.ataxia.note': 'Prueba dedo-nariz y talón-rodilla. Solo puntuar si desproporcionada respecto a la paresia.',
    ...
    'nihss.sensory.note': 'Evaluar con aguja. Solo defecto severo o hemihipoestesia puntuable si alteración de conciencia.',
    'nihss.sensory.opt-0': 'Normal — sin pérdida sensitiva',
    'nihss.sensory.opt-1': 'Leve-moderada — hipoestesia, pero consciente del tacto',
    'nihss.sensory.opt-2': 'Severa o total — no reconoce el tacto en la cara, brazo y pierna',

    // 9. Lenguaje
    'nihss.language.label': '9. Lenguaje / Afasia',
    'nihss.language.note': 'Descripción de lámina, denominación de objetos y lectura de frases estándar.',
    'nihss.language.opt-0': 'Normal — sin afasia',
    'nihss.language.opt-1': 'Afasia leve-moderada — posible comunicación con dificultad',
    ...
    'nihss.dysarthria.note': 'Leer o repetir palabras de la lista estándar. Anotar N/A si intubado u otra causa.',
    'nihss.dysarthria.opt-0': 'Normal',
    'nihss.dysarthria.opt-1': 'Leve-moderada — habla con dificultad pero se comprende',
    ...
    'nihss.neglect.note': 'Estimulación simultánea bilateral. Evaluar también negligencia visual y espacial.',
    ...
    'nihss.result.normal.desc': 'Exploración neurológica sin déficit evidente. Monitorizar estrechamente ante posible fluctuación.',
    'nihss.result.mild': 'Ictus leve',
    'nihss.result.mild.desc': 'Déficit neurológico mínimo. Candidato potencial a tratamiento trombolítico si criterios cumplidos.',
    'nihss.result.moderate': 'Ictus moderado',
    'nihss.result.moderate.desc': 'Déficit neurológico significativo. Evaluar elegibilidad para trombólisis i.v. o trombectomía mecánica.',
    'nihss.result.moderate_severe': 'Ictus moderado-grave',
    'nihss.result.moderate_severe.desc': 'Déficit grave con compromiso funcional importante. Considerar trombectomía mecánica si oclusión de gran vaso.',
    'nihss.result.severe': 'Ictus grave',
    'nihss.result.severe.desc': 'Déficit neurológico severo. Priorizar intervención urgente y monitorización intensiva.',
  ...
  eu: {
    ...
    'index.subtitle': 'Osasun profesionalentzako ebaluazio kliniko estandarizatutako tresnak',
    ...
    'barthel.description': 'Eguneroko bizitzako 10 oinarrizko jardueratan autonomia funtzionala ebaluatzen du. Geriatrian, neurologian eta errehabilitazioan asko erabiltzen da.',
    'barthel.instructions': 'Aukeratu pazientearen uneko gaitasuna hobekien deskribatzen duen aukera jarduera bakoitzean. Azken 24-48 orduetan behatutako portaeran oinarritu.',
    ...
    'barthel.feeding.opt-10': 'Independentea — laguntzarik gabe jaten du denbora arrazoizkoan',
    'barthel.feeding.opt-5': 'Laguntza behar du — elikagaiak mozteko, ogia zabaltzeko...',
    ...
    'barthel.grooming.opt-5': 'Independentea — aurpegia garbitu, orraztea, bizarra kendu',
    'barthel.grooming.opt-0': 'Dependentea — laguntza behar du',

    'barthel.dressing.label': 'Janztea',
    'barthel.dressing.opt-10': 'Independentea — laguntzarik gabe janzten eta eraizten da',
    'barthel.dressing.opt-5': 'Laguntza behar du — gutxienez erdia laguntzarik gabe egiten du',
    ...
    'barthel.bladder.opt-10': 'Kontinentea — istripu gabe, egunez eta gauez lehorra',
    'barthel.bladder.opt-5': 'Noizbehineko istripua — egunean bein baino gutxiago',
    ...
    'barthel.toilet.opt-5': 'Laguntza behar du — orekan eusten du, bakarrik garbitzen da',
    ...
    'barthel.transfers.opt-5': 'Laguntza handia — eseri daiteke, laguntza behar du transferitzeko',
    'barthel.transfers.opt-0': 'Dependentea — ezin da eseri',

    'barthel.mobility.label': 'Deambulazio',
    'barthel.mobility.opt-15': 'Independentea — laguntzarik gabe 50m ibiltzen da',
    'barthel.mobility.opt-10': 'Laguntza behar du — gainbegiratze fisikoa edo hitzezko',
    ...
    'results.independent.desc': 'Pertsona eguneroko bizitzako oinarrizko jardueretan guztiz independentea da.',
    'results.mild': 'Menpekotasun arina',
    'results.mild.desc': 'Zenbait jarduera arrunterako laguntza minimoa behar du.',
    'results.moderate': 'Menpekotasun moderatua',
    'results.moderate.desc': 'Oinarrizko hainbat eguneroko jarduerarako laguntza behar du.',
    ...
    'results.total.desc': 'Eguneroko bizitzako oinarrizko jarduera guztietarako laguntza behar du.',
    ...
    'footer.disclaimer': 'Profesionalen erabilerarako tresna. Ez du irizpide klinikoa ordezkatzen.',
    ...
    'nihss.description': 'Iktus iskemiko akutuan 15 itemaren bidez defizit neurologikoa kuantifikatzen du. Tratamendua aukeratzeko eta pronostiko funtzionala aurresateko erabiltzen da.',
    'nihss.instructions': 'Behatutako erantzunaren arabera puntuatu. Ez argibiderik eman. Zalantzarik badago, puntuazio altuena aukeratu. Amputazio edo irisgarritasun eza dela eta ezin bada ebaluatu, 9 (N/A) jarri.',
    ...
    'nihss.loc.opt-2': 'Estupor — estimulazio errepikatu edo mingarria behar du',
    'nihss.loc.opt-3': 'Koma — erreflexuzko erantzunak edo erantzunik ez',

    // 1b. Ahozko galderak
    'nihss.loc_questions.label': '1b. Ahozko galderak',
    'nihss.loc_questions.note': 'Hilabetea eta adina galdetu. Ez lagundu keinuekin.',
    ...
    'nihss.loc_commands.note': 'Begiak ireki/itxi eta eskua itxi/ireki (ez-paretikoa) agindu.',
    ...
    'nihss.gaze.note': 'Borondatezko edo erreflexuzko (okulozefalikoaren) begien mugimendu horizontalak soilik.',
    'nihss.gaze.opt-0': 'Normala',
    'nihss.gaze.opt-1': 'Paresia partziala — desbideraketa edo paresia baina ez behartua',
    'nihss.gaze.opt-2': 'Desbideraketa behartua — gaindiezina',

    // 3. Ikusmen-eremuak
    'nihss.visual.label': '3. Ikusmen-eremuak',
    'nihss.visual.note': 'Lau koadrantetan begi bakoitzeko ikusmen-eremua ebaluatu.',
    ...
    'nihss.facial_palsy.opt-1': 'Paresia txikia — asimetria irribarrean, naso-labio zimurra laua',
    'nihss.facial_palsy.opt-2': 'Paresia partziala — aurpegi beheko erdiko paralisi osoa',
    ...
    'nihss.upper_limbs.note': 'Besoa 90° (eserita) edo 45° (etzanda) luzatuta mantendu 10 s. N/A amputazioa edo beste arrazoiren bat bada.',
    ...
    'nihss.arm.opt-3': 'Grabitatearen aurkako ahaleginik ez — erori, mugitu daiteke',
    ...
    'nihss.lower_limbs.note': 'Hanka 30° etzanda luzatuta mantendu 5 s. N/A amputazioa edo beste arrazoiren bat bada.',
    ...
    'nihss.leg.opt-3': 'Grabitatearen aurkako ahaleginik ez — erori, mugitu daiteke',
    ...
    'nihss.ataxia.note': 'Hatz-sudur eta orpo-belaunik proba. Paresiarekiko desproportzionala bada soilik puntuatu.',
    ...
    'nihss.sensory.note': 'Orratz bidez ebaluatu. Kontzientzia-aldaketetan defekto larria soilik puntuatzen da.',
    'nihss.sensory.opt-0': 'Normala — sentikortasun-galeraren barik',
    'nihss.sensory.opt-1': 'Arin-moderatua — hipoestesia baina ukimena nabaitzen du',
    'nihss.sensory.opt-2': 'Larria edo osoa — ukimena ez du ezagutzen aurpegian, besoan eta hankean',

    // 9. Hizkuntza
    'nihss.language.label': '9. Hizkuntza / Afasia',
    'nihss.language.note': 'Laminaren deskribapena, objektuen izendapena eta esaldien irakurketa estandarrak.',
    'nihss.language.opt-0': 'Normala — afasiarik ez',
    'nihss.language.opt-1': 'Afasia arin-moderatua — komunikazioa posible zailtasunarekin',
    'nihss.language.opt-2': 'Afasia larria — komunikazio zatikakoa',
    'nihss.language.opt-3': 'Mutismo / afasia globala',

    // 10. Disartria
    'nihss.dysarthria.label': '10. Disartria',
    'nihss.dysarthria.note': 'Zerrenda estandarreko hitzak irakurri edo errepikatu. N/A intubatuta badago edo beste arrazoi bat.',
    'nihss.dysarthria.opt-0': 'Normala',
    'nihss.dysarthria.opt-1': 'Arin-moderatua — zailtasunez hitz egiten du baina ulertzen da',
    ...
    'nihss.neglect.note': 'Estimulazio aldebikoa aldi berean. Arreta-eza bisual eta espaziala ere ebaluatu.',
    'nihss.neglect.opt-0': 'Normalitate barik',
    'nihss.neglect.opt-1': 'Modalitate batean arreta-eza edo extinzioa',
    'nihss.neglect.opt-2': 'Hemi-arreta-eza sakona modalitate batean baino gehiagotan',

    // NIHSS emaitza mailak
    'nihss.result.normal': 'Defizitrik ez',
    'nihss.result.normal.desc': 'Azterketa neurologikoan defizit nabarmen eza. Jarraipena egin behar da fluktuazio posiblearen aurrean.',
    'nihss.result.mild': 'Iktus arina',
    'nihss.result.mild.desc': 'Defizit neurologiko minimoa. Irizpideak betetzen badira, tratamendu tronbolítikorako hautagai posiblea.',
    'nihss.result.moderate': 'Iktus moderatua',
    'nihss.result.moderate.desc': 'Defizit neurologiko esanguratsua. Trombólisi i.b. edo trombektomia mekanikorako hautagarritasuna ebaluatu.',
    'nihss.result.moderate_severe': 'Iktus moderatu-larria',
    'nihss.result.moderate_severe.desc': 'Konpromiso funtzional garrantzitsuarekin defizit larria. Hodi handiko oklusioaren kasuan trombektomia mekanikoa kontuan hartu.',
    'nihss.result.severe': 'Iktus larria',
    'nihss.result.severe.desc': 'Defizit neurologiko larria. Presako esku-hartzea eta jarraipen intentsiboa lehenetsi.',
